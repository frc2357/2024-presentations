...
public class DriveChoreoPathBadZero extends SequentialCommandGroup {
   ...
   */
  public DriveChoreoPathBadZero(String trajectoryFileName) {
  ...
  public DriveChoreoPathBadZero(
    ...
    if (setPoseToStartTrajectory) {
      addCommands(new InstantCommand(() -> Robot.swerve.setPoseAndGyro(m_startingState.getPose())));
    }
    ...
    addCommands(
        ...
        new InstantCommand(
            () -> System.out.println("[DriveChoreoPathBadZero] RUNNING PATH: " + m_pathName)),
